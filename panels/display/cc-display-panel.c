...
#include <libsagarmatha-desktop/gnome-rr-config.h>
#include <gdk/gdkx.h>
#include <X11/Xlib.h>
...
{
  /* Keep this string in sync with gnome-desktop/libsagarmatha-desktop/gnome-rr-labeler.c */
...
begin_version2_apply_configuration (CcDisplayPanel *self, GdkWindow *parent_window, guint32 timestamp)
{
  ...
  self->priv->proxy = g_dbus_proxy_new_for_bus_sync (G_BUS_TYPE_SESSION,
                                                     ...
                                                     "/org/sagarmatha/SettingsDaemon/XRANDR",
                                                     "org.sagarmatha.SettingsDaemon.XRANDR_2",
                                                     NULL,
                                                     &error);
