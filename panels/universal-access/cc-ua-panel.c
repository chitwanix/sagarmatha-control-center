...
cc_ua_panel_init (CcUaPanel *self)
{
  ...
  priv->interface_settings = g_settings_new ("org.sagarmatha.desktop.interface");
  priv->wm_settings = g_settings_new ("org.sagarmatha.desktop.wm.preferences");
  priv->kb_settings = g_settings_new ("org.sagarmatha.desktop.a11y.keyboard");
  priv->mouse_settings = g_settings_new ("org.sagarmatha.desktop.a11y.mouse");
  priv->application_settings = g_settings_new ("org.sagarmatha.desktop.a11y.applications");
  priv->mediakeys_settings = g_settings_new ("org.sagarmatha.settings-daemon.plugins.media-keys");
