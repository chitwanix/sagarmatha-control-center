			       ...
			       CcWacomPage *page)
{
	...
	gtk_builder_add_from_resource (priv->mapping_builder,
                                       "/org/sagarmatha/control-center/wacom/button-mapping.ui",
                                       &error);
...
display_clicked_cb (GtkButton   *button,
		    CcWacomPage *page)
{
    g_spawn_command_line_async ("sagarmatha-settings display", NULL);
	return TRUE;
}
...
cc_wacom_page_init (CcWacomPage *self)
{
	...
	gtk_builder_add_objects_from_resource (priv->builder,
                                               "/org/sagarmatha/control-center/wacom/sagarmatha-wacom-properties.ui",
                                               objects,
                                               &error);
	if (error != NULL) {
		g_warning ("Error loading UI file: %s", error->message);
	       ...
	       const char  *icon_name)
{
	...
	resource = g_strdup_printf ("/org/sagarmatha/control-center/wacom/%s.svg", icon_name);
