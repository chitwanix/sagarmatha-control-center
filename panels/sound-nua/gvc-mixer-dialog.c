                              ...
                              GObjectConstructParam *construct_params)
{
        ...
        ca_context_change_props (self->priv->sound_context, CA_PROP_APPLICATION_NAME, "sagarmatha", CA_PROP_APPLICATION_ID, "org.Sagarmatha", NULL);
        ...
        GSettings * sound_settings = g_settings_new("org.sagarmatha.sounds");
        GSettings * desktop_sound_settings = g_settings_new("org.sagarmatha.desktop.sound");

        GtkWidget * sounds_grid = gtk_grid_new ();
        gtk_grid_set_column_spacing (sounds_grid, 6);
        gtk_grid_set_row_spacing (sounds_grid, 3);

        add_sound_effect_selector (sounds_grid, 0, _("Starting Sagarmatha:"), sound_settings, "login-file", "login-enabled", self);
        ...
        add_sound_effect_selector (sounds_grid, 11, _("Leaving Sagarmatha:"), sound_settings, "logout-file", "logout-enabled", self);
