                             ...
                             SagarmathaControlCenter      *shell)
{
  ...
  sagarmatha_control_center_show (shell, GTK_APPLICATION (application));

  if (show_overview)
    {
      sagarmatha_control_center_set_overview_page (shell);
    }
  ...
  sagarmatha_control_center_present (shell);
...
help_activated (GSimpleAction *action,
                ...
                gpointer       user_data)
{
  SagarmathaControlCenter *shell = user_data;
...
main (int argc, char **argv)
{
  ...
  notify_init ("sagarmatha-control-center");

  shell = sagarmatha_control_center_new ();

  /* enforce single instance of this application */
  application = gtk_application_new ("org.sagarmatha.ControlCenter", G_APPLICATION_HANDLES_COMMAND_LINE);
