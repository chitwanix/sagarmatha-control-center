...
/* run-passwd.c: this file is part of users-admin, a sagarmatha-system-tools frontend
 ...
 * 02110-1335, USA.
 *
 * Most of this code originally comes from sagarmatha-about-me-password.c,
 * from sagarmatha-control-center.
 */
