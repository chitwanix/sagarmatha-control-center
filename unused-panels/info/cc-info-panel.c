...
#define MEDIA_HANDLING_SCHEMA "org.sagarmatha.desktop.media-handling"

/* Session */
#define GNOME_SESSION_MANAGER_SCHEMA        "org.sagarmatha.desktop.session"
                    ...
                    char **date)
{
  ...
  error = NULL;
  if (!g_file_get_contents (DATADIR "/sagarmatha/sagarmatha-version.xml",
                            &contents,
                            &length,
                            &error))
    return FALSE;
