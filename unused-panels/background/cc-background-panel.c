...
#include <libsagarmatha-desktop/cdesktop-enums.hs>
...
#define WP_PATH_ID "org.sagarmatha.desktop.background"
...
{
  return "help:sagarmatha-help/look-background";
}
                      ...
                      GdkRectangle      *rectangle)
{
  ...
  path = g_build_filename (g_get_user_cache_dir (), "sagarmatha-control-center", NULL);
