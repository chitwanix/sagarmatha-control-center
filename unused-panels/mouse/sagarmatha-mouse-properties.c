...
#include <gdk/gdk.h>
#include <gdk/gdkx.h>
#include <sagarmatha-settings-daemon/gsd-enums.h>
#include <math.h>

#include "sagarmatha-mouse-properties.h"
...
{
	mouse_settings = g_settings_new ("org.sagarmatha.settings-daemon.peripherals.mouse");
	touchpad_settings = g_settings_new ("org.sagarmatha.settings-daemon.peripherals.touchpad");
